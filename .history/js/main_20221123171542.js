...
function Chicken() {
  ...
  earRight.position.z = 60 * zoom;
  earRight.position.x = 8 * zoom;
  earRight.position.y = -25 * zoom;
  ...
  earLeft.position.z = 60 * zoom;
  earLeft.position.x = -1 * zoom;
  earLeft.position.y = -25 * zoom;
