...
function Grass() {
  ...
  const createSection = (color) =>
    new THREE.Mesh(
      // BoxGeometry là một lớp hình học dành cho hình khối chữ nhật với 'width', 'height' cao' và 'dept' nhất định. Khi tạo, khối lập phương có tâm ở gốc tọa độ, với mỗi cạnh song song với một trong các trục.
