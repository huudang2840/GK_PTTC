...
function Grass() {
  ...
  const createSection = (color) =>
    new THREE.Mesh(
      // BoxGeometry là một lớp hình học dành cho hình khối chữ nhật với 'width', 'chiều cao' và 'chiều sâu' nhất định. Khi tạo, khối lập phương có tâm ở gốc tọa độ, với mỗi cạnh song song với một trong các trục.
