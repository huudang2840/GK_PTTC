...
function Chicken() {
  ...
  eyeRight.position.z = 48 * zoom;
  eyeRight.position.x = 10 * zoom;
  eyeRight.position.y = -10 * zoom;
  ...
  const nose = new THREE.Mesh(
    new THREE.BoxBufferGeometry(10 * zoom, 4 * zoom, 5 * zoom),
    new THREE.MeshPhongMaterial({ color: 0xdd0c0c, flatShading: true })
  );
  nose.position.z = 46 * zoom;
